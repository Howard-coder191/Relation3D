...
class ScanNet200Dataset(Dataset):
    ...
    def load(self, filename):
        ...
        if self.with_label:
            ...
            scannet200_labels = np.load('dataset/scannet200/' + filename.split('/')[-2] + '/' + scene_id[5:] + '.npy')[:,10:12]
            dummy_sem_label, dummy_inst_label = scannet200_labels[:,0], scannet200_labels[:,1]
